...
set :server_name, 'eltanin'
set :user, 'zerosim'
set :repository_name, 'countingthings'

set :domain, "#{server_name}.uberspace.de"
set :deploy_to, "/home/#{user}/rails"
set :repository, "https://github.com/simonespunkt/#{repository_name}.git"
set :branch, 'master'
...
set :shared_paths, ['config/database.yml', 'log', 'tmp', 'public/uploads','config/secrets.yml','config/application.yml']
